...
\begin{definition}
    ...
    \begin{enumerate}
        \item {
            ...
            Where \( C_{f_1} \) is the cone of \( f_1 \), and the top row is distinguished.
        }
    \item {
            ...
            Where \( C_{f_2} \) is the cone of \( f_2 \), and the middle row is distinguished.
        }
    \item {
        ...
        Where \( C_{f_3} \) is the cone of \( f_3 \), and the bottom row is distinguished.
    }
    \end{enumerate}
