The goal of this section is to define what an ``algebraic triangulated category'' is, as well as ``DG-modules'', which as deiscussed earlier, is necessary to connect Toda brackets to Massey products.
