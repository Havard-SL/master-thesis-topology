    ...
    \begin{enumerate}
        ...
        \item {
            ...
            \begin{align*}
                ...
                a \otimes b &\mapsto (-1)^{ij} c_\Cc \tuple*{ b \otimes a }
            \end{align*}
        }
    \end{enumerate}
\end{definition}
...
\begin{remark}[Functor category structure from Borceux]
    ...
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    NOTE: The notation causes some ambiguity here and so it is neccesary to specify that in the bottom right of the above diagram, \( ? \in \Cc^{\op}(A', A'')_{k - j} \).
