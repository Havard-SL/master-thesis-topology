...
\begin{remark}[Functor category structure from Borceux]
    The elements on the right side are part of the \( n \)-th component of the chain complexes.
    \begin{equation}
    ...
    \begin{multline*}
        \iota_n: \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) }_n \otimes \Cc(A', A'')_{n - k} \\
