...
\begin{definition}[\( \C_{\dg}(\Mod(R)) \)]
    ...
    \begin{enumerate}
        ...
        \item {
            ...
            \[
                \bigtimes_{p \in \Zb} g_p \in [B, C]_i = \prod_{p \in \Zb} \Mod(R)(B_p, C_{p + i}) \text{ and } \bigtimes_{p \in \Zb} f_p \in [A, B]_j = \prod_{p \in \Zb} \Mod(R)(A_p, B_{p + j})
            \]
            as follows
            \begin{align*}
                c_{\C_{\dg}(\Mod(R)), n}: \tuple{ \C_{\dg}(\Mod(R))(B, C) \otimes \C_{\dg}(\Mod(R))(A, B) }_n &\to \C_{\dg}(\Mod(R))(A, C)_n \\
                \iota_{i, j} \tuple{\tuple{ \bigtimes_{p \in \Zb} g_p } \otimes \tuple{ \bigtimes_{p \in \Zb} f_p } } &\mapsto \bigtimes_{p \in \Zb} g_{p + j} \circ f_p
            \end{align*}
    ...
    \begin{enumerate}
        \item {
            ...
            \begin{align*}
                ...
                \tuple{ \bigtimes_{p \in \Zb} g_p } \times \tuple{ \bigtimes_{p \in \Zb} f_p } &\mapsto \bigtimes_{p \in \Zb} g_{p + j} \circ f_p.
            \end{align*}
        ...
        \item {
            ...
            \begin{align*}
                &( d_{(A, C), n} \circ c_n - c_{n + 1} \circ d_{(B, C) \otimes (A, B), n} )\tuple{ \iota_{i, j} \tuple{\tuple{ \bigtimes_{p \in \Zb} g_p } \otimes \tuple{ \bigtimes_{p \in \Zb} f_p } } } \\
                &= d_{(A, C), n}\tuple{c_n \tuple{ \iota_{i, j} \tuple{\tuple{ \bigtimes_{p \in \Zb} g_p } \otimes \tuple{ \bigtimes_{p \in \Zb} f_p } } }} - c_{n + 1} \tuple{ d_{(B, C) \otimes (A, B), n}\tuple{ \iota_{i, j} \tuple{\tuple{ \bigtimes_{p \in \Zb} g_p } \otimes \tuple{ \bigtimes_{p \in \Zb} f_p } } } } \\
                &= d_{(A, C), n}\tuple{ \bigtimes_{p \in \Zb} g_{p + j} \circ f_p } - c_{n + 1} \tuple{ d_{(B, C) \otimes (A, B), n}\tuple{ \iota_{i, j} \tuple{\tuple{ \bigtimes_{p \in \Zb} g_p } \otimes \tuple{ \bigtimes_{p \in \Zb} f_p } } } } \\
                WIP
            \end{align*}
        }
    \end{enumerate}
