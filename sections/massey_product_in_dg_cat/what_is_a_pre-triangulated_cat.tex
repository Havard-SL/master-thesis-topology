...
\begin{remark}[Functor category structure from Borceux]
    Let
    \[
        \eta = \set{\eta_n}_{n \in \Zb} \text{ where } \eta_n \in \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) }_n
    \]
    and let
    \[
        f = \set{f_n}_{n \in \Zb} \text{ where } f_i \in \Cc(A', A'')_n.
    \]
    \begin{equation}
    ...
    \begin{multline*}
        \iota_{k, j}: \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) }_j \otimes \Cc(A', A'')_{k - j} \\
        \hookrightarrow \tuple{ \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) } \otimes \Cc(A', A'') }_k
    \end{multline*}
    ...
    where
    \begin{align*}
        \phi_{A', A'', j}:  \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) }_j &\to \left[ \Cc(A', A''), \C_{\dg}(F(A'), G(A'')) \right]_j \\
    ...
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    And finally take the product of this map over all \( A', A'' \in \Cc \) to get the morphism
    \begin{center}
        \newcommand{\height}{1cm}
        %
        \mmznext{meaning to context=\height}
        \begin{tikzpicture}
            \diagram{m}{\height}{1cm} {
                \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) \\
                \prod_{A', A'' \in \Cc} \left[ \Cc(A', A''), \C_{\dg}(F(A'), G(A'')) \right] \\
            };

            \draw[math]
                (m-1-1) edge node {\prod_{A', A'' \in \Cc} \phi_{A', A''}} (m-2-1);
        \end{tikzpicture}
        %
        \mmznext{meaning to context=\height}
        \begin{tikzpicture}
            \diagram{m}{\height}{1cm} {
                \eta_n \\
                \bigtimes_{A', A'' \in \Cc} \bigtimes_{k \in \Zb} \psi_{A', A'', k} \circ \iota_{k,j}(\eta_j \otimes ? ). \\
            };
        ...
        \end{tikzpicture}
    \end{center}
    Doing a similar constructian as in \autoref{eq:functor_category_borceux} look at the composition
    \begin{center}
        \newcommand{\height}{1cm}
        %
        \mmznext{meaning to context=\height}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[math] ($(m-1-1.south) + (-0.25, 0)$) to node[swap] {\prod_{A', A'' \in \Cc} \widetilde{\phi}_{A', A''}} ($(m-2-1.north) + (-0.25, 0)$);
        \end{tikzpicture}
    \end{center}
    ...
    \[
        H \stackrel{\iota}{\hookrightarrow} \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A))
    \]
    where the following holds
    \[
        \prod\limits_{A', A'' \in \Cc} \phi_{A', A''} \circ \iota = \prod_{A', A'' \in \Cc} \widetilde{\phi}_{A', A''} \circ \iota
    \]
\end{remark}
