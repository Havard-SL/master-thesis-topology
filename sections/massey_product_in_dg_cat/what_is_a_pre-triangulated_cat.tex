...
\begin{remark}[Functor category structure from Borceux]
    ...
    \begin{multline*}
        \iota_{n, k}: \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) }_k \otimes \Cc(A', A'')_{n - k} \\
        \hookrightarrow \tuple{ \tuple{ \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A)) } \otimes \Cc(A', A'') }_n
    \end{multline*}

    Take the adjoint of \autoref{eq:functor_category_borceux} morphism gives the chain complex morphism
    \[
        \phi_{A', A''} = \set{\phi_{A', A'', n}}_{n \in \Zb}, \text{ where } \phi_{A', A'', n} = \prod_{k \in \Zb} \tuple{ \eta_n \mapsto \psi_{A', A'', k} \circ \iota_{n,k}(\eta_n \otimes ? ) }
    \]
    \begin{center}
        \newcommand{\height}{1cm}
        %
        ...
        \begin{tikzpicture}
            \diagram{m}{\height}{1cm} {
                \eta_n \\
                \bigtimes_{k \in \Zb} \psi_{A', A'', k} \circ \iota_{n,k}(\eta_n \otimes ? ). \\
            };
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            \diagram{m}{\height}{1cm} {
                \eta_n \\
                \bigtimes_{A', A'' \in \Cc} \bigtimes_{k \in \Zb} \psi_{A', A'', k} \circ \iota_{n,k}(\eta_n \otimes ? ). \\
            };
    ...
    \begin{center}
        \begin{tikzpicture}
            \diagram{m}{1cm}{1cm} {
                \prod_{A \in \Cc} \C_{\dg}(\Mod(R))(F(A), G(A))test4 \\
                \prod_{A', A'' \in \Cc} \left[ \Cc(A', A''), \C_{\dg}(F(A'), G(A'')) \right] \\
            };

            \path[math2] ([xshift=2.5mm]m-1-1.south) edge node {\prod\limits_{A', A'' \in \Cc} \phi_{A', A''}} ([xshift=2.5mm]m-2-1.north);
