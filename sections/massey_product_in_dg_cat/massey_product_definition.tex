...
\begin{definition}
    ...
    \]
    This is a subset of \( H^* \tuple{\Cc \tuple{X_1, X_4}} \) and therefore also a subset of \( H^*(\Cc)(X_1, X_4) \), called the \emph{Massey product of \( g_3, g_2 \) and \( g_1 \)}, and is denoted as \( \toda{g_3, g_2, g_1 } \).
\end{definition}
