...
% MS-Question: Should I specify this or go straight to just the definition of enrichment (where the monoid in the monoidal category defines the tensor product.)? If not, does the tensor product for GRMod_R have a similar universal property as it has for modules?<
    % -> Maybe have a universal property?
\begin{remark}
