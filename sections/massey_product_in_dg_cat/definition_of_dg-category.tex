...
\begin{remark}[Tensor product and internal hom adjunction in \( \C(\Mod(R)) \)]
        ...
        \begin{tikzpicture}
            ...
            \draw[math]
                (m-1-1) edge node {d_n} (m-1-2)
                    edge node {s_n \circ \phi_{f, n}} (m-2-1)
                (m-1-2) edge node {s_{n + 1} \circ \phi_{f, n + 1}} (m-2-2)
    ...
    \begin{multline*}
        ...
        = \bigtimes_{k \in \Zb} \tuple{ f_{k + n + 1} \circ \iota_{k + n + 1, n + 1} (d_n(a) \otimes ?) - d_{k + n} \circ f_{k + n} \circ \iota_{k + n, n} (a \otimes ?) + (-1)^n f_{k + n} \circ \iota_{k + n, n} (a \otimes d_n(?)) } \\
        = \bigtimes_{k \in \Zb} \tuple{ WIP }
    \end{multline*}
\end{remark}
