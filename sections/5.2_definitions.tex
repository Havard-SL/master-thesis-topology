...
% TODO: Bestem kva eg skal gjere med direkte sum notasjonen, og deretter forenkla tidelegare notasjon. Anta for no at det gir meining.
% Before we define the cone in \( \dgM \), consider the following notation which we will use in the definition.
...
%     The reason for specifying the above notation is because it could be confused with 
% \end{notation}
