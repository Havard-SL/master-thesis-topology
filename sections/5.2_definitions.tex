...
\begin{remark}
    Due to our notation of product not having a order, as talked about in \autoref{not:coprod_prod_forvirring}, it follows that \( d_{\Sigma F} = -d_F \) for any DG-module \( F \).

    This is because
    \[
        d_{\Sigma F} = \tuple{d_{\Sigma F A}}_A = \tuple{d_{\Sigma F A, i}}_{A, i} = \tuple{-d_{F A, i + 1}}_{A, i} = \tuple{-d_{F A, i}}_{A, i} = -d_F.
    \]
\end{remark}
