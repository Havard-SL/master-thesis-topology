...
\begin{lemma}
    One has that \( 0 \in \Mc\tuple{M, M} \) and \( \pm(\cdot(g - 1)) \in \Mc\tuple{M, M} \) are the only non-surjective morphisms.
\end{lemma}
\begin{proof}
    TODO
\end{proof}
        ...
        \item {
            ...
            \begin{enumerate}
                ...
                \item {
                    ...
                    By there is some \( j, k \in \Nb \) such that \( p_{S^{n_B} \oplus M^{m_B}}^{M_j} \circ F(f) \circ i_{S_k}^{M^{n_A} \oplus M^{m_A}} \).
                }
            \end{enumerate} 
        }
    \end{enumerate}
