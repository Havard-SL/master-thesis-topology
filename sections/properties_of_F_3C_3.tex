...
\begin{proof}
    ...
    \begin{enumerate}
        \item {
            ...
            \begin{enumerate}
                \item {
                    ...
                    \[ % Not correct TODO, because \tilde{P} is a direct summand of S-es, not just one S.
        ...
        \item {
            ...
            Also, by assumption,
            \[
                F(f) = p_{M, M} \circ \phi ( F(f) ) = \cdot(g-1) \in \set{0, \cdot( \pm(g - 1) )} \subseteq \Nc.
            \]
            However, look at \( \alpha = \tuple{ 0, \dots, 0, \Id_M, 0, \dots, 0 } \), that is only non-zero at coordinate \( j + 1 \).
            ...
            \begin{center}
                \begin{tikzpicture}
                    ...
                    \draw[math]
                        ...
                        (m-1-2) edge node {(0)^j \oplus ( \mu )^k} (m-1-3)
                        (m-1-3) edge node {(0)^j \oplus ( \nu )^k} (m-1-4);
                \end{tikzpicture}
            \end{center}
...
\begin{proof}
    ...
    \begin{enumerate}
        \item {
            ...
            Want to show that for all \( \tilde{P} \in \Pc \), one has that
            \[
            ...
            \begin{enumerate}
                \item {
                    ...
                    That implies that \( L_{S, S, S} \neq 0 \) in the \( b, a \)-th coordinate. Therefore for \( \alpha = \tuple{ 0, \dots 0, \Id_S, 0, \dots, 0 } \) a \( (n_a + m_a) \)-tuple that is entirely zero, except for in coordinate \( a \) where it is \( \Id_S \).
                    ...
                    \[
                        ...
                        = \beta
                    \]
                    one gets that the \( b \)-th coordinate of \( \beta \) has the value \( F(f)_{S_a}^{S_b} \) which is by assumption non-zero, and so \( \phi_B \circ F(f)_* \circ \phi_A^{-1} \) is non-zero.
                }
                \item {
