...
\begin{proof}
    ...
    \begin{enumerate}[label={(\bfseries TR\arabic*)}]
        ...
        \item {
            By a similar argument as in {\bf (TR2)}, it suffices to check that for any two standard triangles, given the following commutative diagram consisitng of the solid morphisms
            \begin{center}
                \begin{tikzpicture}
                    \diagram{m}{1cm}{1cm} {
                        A \& B  \& C_f \& \Sigma A \\
