...
By \cite[Lemma, Subsection 7.5]{Krause_2007} it follows that \( \StMod(R) \) and \( \Stmod(R) \) are in fact what we call an ``algebraic triangulated category''. The definition of an algebraic triangulated category is given in \autoref{section:alg_tri_cats}.