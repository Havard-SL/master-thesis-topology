...
\begin{definition}[The functor \( \Omega \)]
    ...
    \begin{itemize}
        ...
        \item {
            ...
            We have that for a morphism \( f: A \to B \), there exists a morphism \( p_f \) from the lifitng property of projective modules such that the right square commutes. Note that the choice of \( p_f \) is \emph{not neccesarily unique}.
