...
\begin{proof}
    ...
    \[
        ...
        \end{aligned}
    \]
    Using those morphisms, one can create the following diagram
    \begin{center}
        \begin{tikzpicture}
            \diagramorigin{m}{1cm}{1cm} {
                A \& B \\
                I \& C \\
                I' \& \& C' \\
                I \& \& \& C \\
...
\begin{proof}
    ...
    \begin{enumerate}[label={(\bfseries TR\arabic*)}]
        ...
        \item {
            ...
            \end{align*}
            Thus there exists a morphism \( \phi: C_{n \circ f} \to C_n \) such that the pushout diagram commutes .
