...
\begin{proof}
    ...
    \begin{enumerate}[label={(\bfseries TR\arabic*)}]
        ...
        \item {
            ...
            Let \( E := \coker(\delta)\). Since \autoref{diag:stmod_tr4_C} is a pushout, we also have that \( E = \coker(\kappa_{C_f} \circ g) \).
            ...
            \begin{center}
                \begin{tikzpicture}
                    ...
                    \draw[math]
                        ...
                        (m-2-1) edge node {\gamma} (m-2-2)
                            edge[curve={height=25pt}] node {\gamma_{C_f}} (m-3-3)
                        (m-2-2) edge[dashed] (m-3-3);
                \end{tikzpicture}
            \end{center}
            ...
            Combining everything, one gets the following equation
            \[
