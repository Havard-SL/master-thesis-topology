...
\begin{proof}
    ...
    \begin{enumerate}[label={(\bfseries T\arabic*)}]
        ...
        \item {
            ...
            Keep in mind the following commutative diagram given by the definition of \( \Sigma f \)
            \begin{center}
                \begin{tikzpicture}
                    \diagram{m}{1cm}{1cm} {
                        A \& I_A \& \Sigma A \\
                ...
                \end{tikzpicture}
            \end{center}
            With the above morphisms in mind, consider the following commutative diagram
            \begin{center}
                \begin{tikzpicture}
                    \diagram{m}{1cm}{1cm} {
                        A \& B \\
                ...
                \end{tikzpicture}
            \end{center}
            Consider the following equalities that follow from the above two commutative diagrams
            \[
