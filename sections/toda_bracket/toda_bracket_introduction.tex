These definitions are based on \cite[Section 3]{Christensen-Frankland_2017}.
...
\begin{definition}
    ...
    one can define the \emph{three-fold Toda bracket of \( f_3, f_2, f_1 \)}, denoted by \( \langle f_3, f_2, f_1 \rangle \) in three different ways:
