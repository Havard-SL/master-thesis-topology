...
\begin{proof}[Proof of Massey products = Toda brackets]
    ...
    \begin{center}
        \begin{tikzpicture}
            \diagram{m}{1cm}{1.8cm} {
                ...
                H^0(\mathbf{h}) \Phi \Sigma^{-1} Y \& H^0(\mathbf{h}) \Phi X_2 \& H^0(\mathbf{h}) \Phi X_3 \& H^0(\mathbf{h}) \Phi Y \\
        ...
        \end{tikzpicture}
    \end{center}
    which can be rewritten to the following commutative diagram,
    \begin{center}
        \begin{tikzpicture}
            \diagram{m}{1cm}{1.8cm} {
                H^0(\mathbf{h}) \Phi X_1 \& H^0(\mathbf{h}) \Phi X_2 \\
            ...
            \draw[math]
                ...
                (m-2-1) edge node {H^0(\mathbf{h}) \Phi (-\Sigma^{-1} \pi)} (m-2-2)
                (m-2-2) edge node {H^0(\mathbf{h}) \Phi f_2} (m-2-3)
                (m-2-3) edge node {\eta \circ (H^0(\mathbf{h}) \Phi \iota)} (m-2-4)
                    edge[equality] (m-3-3)
                (m-2-4) edge node[swap] {(H^0(\mathbf{h}) \Phi \beta) \circ \eta^{-1}} (m-3-4)

                (m-3-3) edge node {H^0(\mathbf{h}) \Phi f_3} (m-3-4);
        \end{tikzpicture}
    \end{center}
    where the middle row is a distinguished triangle.
    ...
    Consider
    \[
        \tilde{\alpha} = \phi \circ (\Phi^{-1} (H^0(\mathbf{h}))^{-1} (\alpha)) \circ \phi^{-1}
    \]
    and
    \[
        \tilde{\beta} = \phi \circ (\Phi^{-1} (H^0(\mathbf{h}))^{-1} (\beta)) \circ \phi^{-1}.
    \]
