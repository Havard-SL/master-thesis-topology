...
\begin{definition}[Shift functor on \( \C(\Ac) \)]
    ...
    Let \( A = \tuple{A_i}_{i \in \Zb} \in \C(\Ac) \) be a chain complex, and let \( d_n^A: A_n \to A_{n + 1} \) denote the \( n \)-th differential.

    Then let \( \Sigma A := \tuple{A_{i + 1}}_{i \in \Zb} \), with \( d_n^{\Sigma A} := -d_{n + 1}^A \).

    Likewise for \( f = \tuple{f_i}_{i \in \Zb} \in \C(\Ac)(A, B) \) be a chain morphism. Then let
    \[
