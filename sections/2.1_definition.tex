...
\begin{definition}[Triangulated category]
    ...
    \begin{enumerate}[label={(\bfseries T\arabic*)}]
        \item {
            ...
            \begin{enumerate}
                \item {
                    For any \( f: X \to Y \) in \( \Tc \), there is some object \( C_f \in \Tc \), called a \emph{cone of \( f \)} along with morphisms \( \iota_f \) and \( \pi_f \), such that there is a triangle
                    \begin{center}
                        \begin{tikzpicture}
                            \diagram{m}{1cm}{1cm} {
                                X \& Y \& C_f \& \Sigma X \\
        ...
        \item {
            ...
            \begin{center}
                ...
                \end{tikzpicture}
            \end{center}
            in \( \Delta \), both of the \emph{shifted triangles}
            \begin{center}
                % \begin{tikzpicture}
                %     \diagram{m}{1cm}{1cm} {
                %         B \& C \& \Sigma A \& \Sigma B, \\
                ...
                \begin{tikzpicture}
                    ...
                    \draw[math]
                        ...
                        (m-1-2) edge node {h} (m-1-3)
                        (m-1-3) edge node {-\Sigma f} (m-1-4)
                        (m-1-6) edge node {-\Sigma^{-1} h} (m-1-7)
