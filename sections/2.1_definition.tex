A triangulated category is closely linked to some objects and morphisms making a ``triangle'', and showing that there are some ``triangles'' that have some useful properties. We start by defining what a triangle in an additive category is.
