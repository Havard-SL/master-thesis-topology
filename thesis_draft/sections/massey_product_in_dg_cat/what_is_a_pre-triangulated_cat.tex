...
\begin{remark}[Functor category structure from Borceux]
    ...
    %     \rightarrowtail \tuple*{ \tuple*{ \prod_{A \in \Cc^{\op}} \C_{\dg}(\Mod(R))(F(A), G(A)) } \otimes \Cc^{\op}(A', A'') }_{i + j}
    % \end{multline*}
    ...
    \[
        H \stackrel{\iota}{\rightarrowtail} \prod_{A \in \Cc^{\op}} \C_{\dg}(\Mod(R))(F(A), G(A))
    \]
